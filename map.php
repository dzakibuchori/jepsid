  ...
  <body>
    <div id="list-wrapper">
      ...
      <nav class="container-fluid">
        <div class="row">
          <li class="col-sm-4 col-xs-4 vehicle"><span><i class="fa fa-car" aria-hidden="true"></i>Vehicles</span></li>
          <li class="col-sm-4 col-xs-4 nav-active map"><span><i class="fa fa-map" aria-hidden="true"></i>Map</span></li>
